...
const features = [
  ...
  ['🛕', 'Heritage', 'Places, temples and local history.', '/explore/heritage'],
  ['🌴', 'Nature', 'Fields, waterways and beautiful landscapes.', '/explore/nature'],
  ['🤝', 'Community', 'People, events, businesses and services.', '/community'],
];
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={styles.page}>
      <View style={[styles.nav, wide && styles.navWide]}>
        ...
        {wide && <View style={styles.links}>{navItems.map(([label, path]) => <Pressable key={path} onPress={() => router.push(path)} accessibilityRole="link"><Text style={styles.link}>{label}</Text></Pressable>)}</View>}
      </View>
      <View style={[styles.hero, wide && styles.heroWide]}>
        <View style={styles.heroCopy}>
          ...
          <Pressable style={styles.button} onPress={() => router.push('/explore')} accessibilityRole="button"><Text style={styles.buttonText}>Explore the village  →</Text></Pressable>
        </View>
